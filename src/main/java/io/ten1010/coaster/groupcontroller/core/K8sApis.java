...
import io.ten1010.coaster.groupcontroller.model.V1Beta2ResourceGroupList;
...
public class K8sApis {
    ...
    private GenericKubernetesApi<V1Beta2ResourceGroup, V1Beta2ResourceGroupList> resourceGroupApi;
    ...
    public K8sApis(ApiClient apiClient) {
        ...
        this.resourceGroupApi = new GenericKubernetesApi<>(
                ...
                V1Beta2ResourceGroupList.class,
