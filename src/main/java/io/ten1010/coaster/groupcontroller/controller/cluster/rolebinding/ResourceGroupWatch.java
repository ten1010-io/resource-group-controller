...
public class ResourceGroupWatch implements ControllerWatch<V1Beta2ResourceGroup> {
    ...
    public static class EventHandler implements ResourceEventHandler<V1Beta2ResourceGroup> {
        ...
        private static List<V1Subject> getSubjects(V1Beta2ResourceGroup obj) {
            if (obj.getSpec() == null) {
                return new ArrayList<>();
            }
        ...
        private static boolean changeExistOnSubjects(V1Beta2ResourceGroup oldObj, V1Beta2ResourceGroup newObj) {
